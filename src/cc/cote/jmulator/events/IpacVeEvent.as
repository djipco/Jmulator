package cc.cote.jmulator.events
{
	...
	/**
	 * An IpacVeEvent object is dispatched whenever the status of an input on an IpacVe board 
	 ...
	 * @since version 2.0b
	 */
	public class IpacVeEvent extends EmulatorEvent
	{
